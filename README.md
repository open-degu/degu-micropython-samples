...
|Piezo_Electric_Sensor|Detect changes in vibration and pressure and transmit if the sensor detected any changes, to the device-shadow. / 振動や圧力を検出し、デバイスシャドウに真理値として送信します。|[Grove - 圧電振動センサー](https://www.seeedstudio.com/Grove-Adjustable-PIR-Motion-Sensor-p-3225.html)|DIO1|
