...
These sample codes are compatible with Degu firmware `v1.0.0-rc1` or later. [Update](https://open-degu.github.io/user_manual/20_software_update/) if your degu firmware version is old.

このサンプルコードに対応しているDeguファームウェアのバージョンは`v1.0.0-rc1`以降です。お使いのDeguファームウェアバージョンが古い場合は、[アップデートしてください。](https://open-degu.github.io/user_manual/20_software_update/)
