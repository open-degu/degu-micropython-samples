...
class BME280:
    ...
    def __init__(self,
        ...
        self.i2c.writeto(self.address, bytearray([BME280_REGISTER_CONTROL, 0x3F]))
        self.t_fine = 0
    ...
    def read_raw_data(self, result):
        ...
        self._l1_barray[0] = BME280_REGISTER_CONTROL_HUM
        self._l1_barray[1] = self._mode
        self.i2c.writeto(self.address, self._l1_barray)
        self._l1_barray[0] = BME280_REGISTER_CONTROL
